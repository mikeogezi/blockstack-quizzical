...
class QuizTaken extends React.Component {
  constructor (props) {
    super(props);
    ...
    return (
      <MuiThemeProvider theme={theme}>
        <Box align="center" className={classes.container}>
          <Header>You Successfully Completed The Quiz</Header>
          <Typography variant="h6">We have submitted your results and you should be hearing back soon.</Typography>
        </Box>
      </MuiThemeProvider>
    );
  }
...
export default withStyles(styles)(QuizTaken);